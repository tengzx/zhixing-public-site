(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const titles = {
      ...
      faq: { en: "Frequently Asked Questions — HourNote", "zh-Hans": "常问问题 — HourNote", "zh-Hant": "常問問題 — HourNote", ja: "よくある質問 — HourNote", es: "Preguntas frecuentes — HourNote", de: "Häufig gestellte Fragen — HourNote" },
